...
export const LIGHT: ThemeColors = {
  ...
  border: "rgba(48, 36, 22, 0.11)",
  borderHi: "rgba(48, 36, 22, 0.18)",
  brass: "#9A6218",
  brassSoft: "rgba(154, 98, 24, 0.12)",
  brassLine: "rgba(154, 98, 24, 0.42)",
  signal: "#0B7F6E",
  text: "#171411",
  textMuted: "#4A433C",
  textFaint: "#7A7268",
  danger: "#C53D32",
  navGlass: "rgba(247, 241, 232, 0.88)",
  shadow: "rgba(40, 28, 12, 0.10)",
  cardShadow: "0 1px 2px rgba(40, 28, 12, 0.04), 0 10px 28px rgba(40, 28, 12, 0.07)",
  inputFill: "#F3EDE4",
};
