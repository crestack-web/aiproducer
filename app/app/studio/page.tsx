  ...
  return (
    <AppShell active="studio" userName={userName} onSignOut={signOut}>
      <div style={{ width: "100%", maxWidth: 920, margin: "0 auto", padding: "28px 20px 48px", boxSizing: "border-box" }}>
        ...
        <h1 style={S.h1}>Create your beat</h1>
        <p style={S.sub}>
          Describe the sound, pick genre and mood, set tempo — then your AI producer guides the session section by
          section.
        </p>
        ...
        <div style={S.card}>
          <textarea
            ...
            rows={4}
            placeholder="Emotional Afrobeats song about falling in love at night, warm guitars, deep bass, catchy percussion."
            style={S.prompt}
          />
          ...
          <div style={{ marginTop: 20 }}>
            ...
            <div style={S.chips}>
              {GENRES.map((g) => (
                <button key={g} type="button" style={genre === g ? S.chipOn : S.chip} onClick={() => setGenre(g)}>
                  {g}
                </button>
              ))}
            </div>
          ...
          <div style={{ marginTop: 18 }}>
            ...
            <div style={S.chips}>
              {MOODS.map((m) => (
                <button key={m} type="button" style={mood === m ? S.chipOn : S.chip} onClick={() => setMood(m)}>
                  {m}
                </button>
              ))}
            </div>
          ...
          <div style={{ marginTop: 20 }}>
            ...
            <div style={S.chips}>
              ...
              <button
                type="button"
                style={beatMode === "upload" ? S.chipOn : S.chip}
                onClick={() => setBeatMode("upload")}
              >
                Upload my beat
              </button>
            </div>
          ...
          {beatMode === "upload" && (
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 14, flexWrap: "wrap" }}>
              ...
              />
              <button type="button" style={S.secondary} onClick={() => fileRef.current?.click()}>
