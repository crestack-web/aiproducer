  ...
  return (
    <div style={S.shell}>
      ...
      <aside className="studio-sidebar" style={S.sidebar}>
        <div style={{ ...S.brand, display: "flex", alignItems: "center", gap: 8, paddingLeft: 8 }}>
          <img src="/logo.svg" alt="" width={22} height={22} style={{ borderRadius: 5, display: "block" }} />
          STUDIO
        </div>
            ...
            <>
              <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 40, marginBottom: 40 }}>
                <div style={{ flex: 1, maxWidth: 520 }}>
                  <div style={{ ...S.eyebrow, display: "inline-flex", alignItems: "center", gap: 8 }}>
                    <img src="/logo.svg" alt="" width={16} height={16} style={{ borderRadius: 3 }} />
                    STUDIO
                  </div>
                ...
                <div className="studio-hero-art" style={{ ...S.heroArt, overflow: "hidden", padding: 24 }}><img src="/logo.svg" alt="Studio" style={{ width: "100%", height: "100%", objectFit: "contain" }} /></div>
              </div>
