        ...
        <div className="studio-main-inner" style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 32px 80px" }}>
            ...
            <section style={{ maxWidth: 560, margin: "0 auto", width: "100%" }}>
              ...
              <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 20, padding: 22 }}>
                ...
                <button type="button" style={{ ...S.primary, width: "100%", marginTop: 22, opacity: creating || (beatMode === "upload" && !beatFile) ? 0.55 : 1 }} disabled={creating || (beatMode === "upload" && !beatFile)} onClick={createAndGenerate}>
                  {creating ? "Creating…" : beatMode === "upload" ? "Start with my beat" : "Create beat"}
                </button>
              </div>
            </section>
          )}
          ...
          {tab === "library" && (
            <section style={{ maxWidth: 720, margin: "0 auto" }}>
              ...
              <p style={{ ...S.sub, marginBottom: 20 }}>Songs, instrumentals, and takes in one place.</p>
              <div style={{ ...S.chips, marginBottom: 18 }}>
              ...
              {libraryTab === "songs" && renderProjects()}
              {libraryTab === "beats" && (projects.length ? renderProjects() : (
                <div style={S.empty}><p style={S.emptyTitle}>No beats yet</p><p style={{ color: C.textMuted, fontSize: 14 }}>AI and uploaded instrumentals show up here.</p></div>
              ))}
...
const S: Record<string, React.CSSProperties> = {
  ...
  card: { background: C.surface, border: `1px solid ${C.border}`, borderRadius: 18, padding: 16, textDecoration: "none", color: "inherit" },
  cover: { width: "100%", aspectRatio: "1", borderRadius: 14, border: `1px solid ${C.border}`, display: "grid", placeItems: "center" },
  title: { fontFamily: "Fraunces, Georgia, serif", fontSize: 17, marginTop: 12, color: C.text },
  meta: { fontSize: 13, color: C.textMuted, marginTop: 4 },
