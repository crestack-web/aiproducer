...
const S: Record<string, React.CSSProperties> = {
  ...
  list: { display: "flex", flexDirection: "column", gap: 2, width: "100%" },
  listRow: {
  ...
  listMeta: { fontSize: 12.5, color: C.textMuted, marginTop: 3 },
  listRight: { fontSize: 12, color: C.textFaint, fontFamily: "'IBM Plex Mono', monospace", flexShrink: 0 },
