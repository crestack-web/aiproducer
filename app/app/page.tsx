        ...
        <div className="studio-main-inner" style={{ maxWidth: 960, margin: "0 auto", padding: "36px 24px 64px" }}>
            ...
            <>
              ...
              <div style={{ marginTop: 12, display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                {projects.slice(0, 12).map((p) => (
                  <Link key={p.id} href={`/app/studio/${p.id}`} style={S.row}>
                    <div>
          ...
          {tab === "library" && (
            <>
              ...
              <p style={S.sub}>Songs, instrumentals, and takes in one place.</p>
                  ...
                  {projects
                    ...
                    .map((p) => (
                      <Link key={p.id} href={`/app/studio/${p.id}`} style={S.row}>
                        <div>
                          <div style={{ fontWeight: 600 }}>{p.title}</div>
                          <div style={{ fontSize: 12.5, color: C.textMuted, marginTop: 2 }}>Session · {p.status}</div>
                        </div>
                        <span style={{ color: C.brass, fontSize: 13, fontWeight: 600 }}>Open</span>
                      </Link>
                    ))}
