...
export default function ProjectDetailPage() {
  ...
  return (
    <AppShell active="studio">
      <div style={{ background: "transparent", minHeight: "100%", color: C.text }}>
        {beatUrl && (
        ...
        {screen === "plan" && (
          <div style={wrap}>
            ...
            <p style={{ color: C.textMuted, fontSize: 14, marginTop: 8 }}>Record each part. Tap any section to jump or retake.</p>
              ...
              {tasks.map((t) => (
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: C.textFaint, marginTop: 4 }}>
                    {isTaskDone(t) ? "✓ Done — tap to retake" : t.required ? "Required" : "Optional"}
                  </div>
                </button>
              ))}
            </div>
