            ...
            {phase === "ready" && (
              <div style={{ marginTop: 20 }}>
                ...
                {!current.required && (
                  <button
                    type="button"
                    style={{ ...btn2, marginTop: 10, color: C.textMuted }}
                    disabled={skipping}
                    onClick={skipCurrent}
                  >
                    Skip this part
            ...
            {phase === "review" && (
              <div style={{ marginTop: 16 }}>
                ...
                {!localBlobUrl && uploading && (
                  <PlayerLoadingState
                    title="Saving take"
                    subtitle="Uploading your performance…"
                    seed={`save-${current.id}`}
                  />
                )}
                <button
                  type="button"
            ...
            {producing ? (
              ...
              <>
                ...
                <div style={{ marginTop: 22, display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  <button
                    type="button"
                    style={masterUrl ? btn : btn2}
                    disabled={producing || !masterUrl}
